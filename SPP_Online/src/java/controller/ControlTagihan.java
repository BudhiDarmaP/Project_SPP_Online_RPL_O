...
/**
 *
 * @author Michael Donny Kusuma ID Tagihan 1 Digit pertaman = jenis pembayaran
 * Digit 2 - 3 = tahun tagihan Digit 4 - 5 = tanggal tagihan Digit 6 - 10 = nis
 */
...
public class ControlTagihan extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getParameter("tagihan").equals("") || request.getParameter("bulan").equals("")) {
                throw new Exception("Data belum lengkap");
            }
            try {
                jumlah = Double.parseDouble(request.getParameter("tagihan"));
            } catch (Exception ej) {
                throw new Exception("Format Tagihan Salah");
            }
